...
export const homePageData = {
  sections: [
    ...
    {
      heading: "What is <span>Segsalerty?</span>",
...

    {
      ...
      sections: [
        {
          heading: "Segsalerty <br /> <span>Resources</span> (SRS)",
        ...
        {
          heading: "Segsalerty <span>Talent Support</span> Initiative (STS)",
          para: "A Foundation of Segsalerty that provides the necessary support for skilled talents to fly. We provide a conducive environment for you to nurture your skills, build your portfolio and get your first job.",
          placeHolder: "Enter email address",
...

    {
      ...
      sections: [
        {
          heading: "Why <span>Segsalerty?</span>",
          ...
          reasons: [
            {
              ...
              subPara:
                "We offer you the opportunity to work, and network with talents of diverse skills while providing progressive development and exceptional career journey.",
            },
            {
              icon: toolImg,
              subHeading: "We create global skilled talents",
              subPara:
                "With our highly vetted mentors and regular skill in-house challenges, our Engineers have stood the test of time in building quality software solutions.",
            },
            {
              icon: verifiedImg,
              subHeading: "Professional and experienced mentors",
              subPara:
                "Our mentors are equipped with knowledge to guide you through early journey in tech to professional level as well as providing moral support.",
            },
          ],
        },
        {
        ...
        {
          heading: "Our <span>development stacks</span>",
...

    {
      ...
      sections: [
        {
          heading: "Numbers are telling our <span>success stories</span>",
        ...
        {
          heading: "What <span>our members</span> are saying",
          ...
          testimonies: [
            {
              testimony:
                "A community that streamlines your tech hurdles by either becoming a part of us or partnering to build amazing products. Are you in search of skilled talents for your projects? We are at your beck and call.",
...

    {
      ...
      sections: [
        {
          heading: "Become a <span>Client</span>",
