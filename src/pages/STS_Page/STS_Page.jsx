...
let iconStep_2 = (
  ...
  >
    <path
      ...
      fill="url(#paint0_linear_888_2)"
    />
    <defs>
      <linearGradient
        id="paint0_linear_888_2"
        x1="0.333374"
        y1="12.0035"
        x2="23.6667"
        y2="12.0035"
    ...
    <div className="STS_PageWrapper desktopMaxWidth">
      <section className="heroSection section_flex ">
        <div className="contentWrapper">
          ...
          <p>
            A talent support platform for developing brilliant and well-vetted
            tech talent with the advent of deploying and situating in a
            recognized spot in the global tech ecosystem while promoting
            diversity, inclusion, and team-building culture in the tech
            industry.
          </p>
      ...
      <section className="strategySection section_with_subSections ">
        ...
        <div className="DSL_strategy should_stack">
          <div className="contentWrapper">
            ...
            <p>
              We believe in harnessing the skill and capacity of talented
              individuals and grooming them to be their better selves through
              self and technical developmental processes
            </p>
          </div>
          ...
          <div className="strategy_cards">
            <div className="card">
              ...
              <div>
                <h5>Discover</h5>
                <p>
                  Our application process helps to discover indigent talents
                  with sound technical ability to succeed however lacking the
                  required support.
                </p>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div>
                <h5>Liberate</h5>
                <p>
                  Through our fully-equipped hub, we provide an enabling
                  environment for admitted fellows to hone their skills based on
      ...
      <section className="openSlotSection section_with_subSections">
        ...
        <div className="frontEnd should_Flex ">
          <div className="contentWrapper">
            ...
            <p>
              Frontend Engineers are some of the most sought-after Software
              Engineers. This program is designed to provide you with in-depth
              knowledge on how to create functional websites by implementing web
              designs through the use of various programming languages.
            </p>
            <div className="ctaWrapper">
              <a className="primaryButton" href="#">
                Apply now
            ...
            <div className="step">
              ...
              <div>
                ...
                <div>
                  <span>STEP 1</span>
                  <p>
                    Complete the call for application and take the assessment
                    test
                  </p>
                </div>
              </div>
            ...
            <div className="step">
              ...
              <div>
                ...
                <div>
                  <span>STEP 4</span>
                  <p>
                    Candidates who pass will receive their acceptance emails and
                    instructions
                  </p>
                </div>
              </div>
