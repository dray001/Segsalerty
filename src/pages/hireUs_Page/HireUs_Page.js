        ...
        <div className='hireUsWrapper '>
          ...
          <section className='client_Section'>
            ...
            <div className='contentWrapper'>
              ...
              <p> Get highly experienced engineers that can help achieve your organization’s goals in due time. What is your company looking to achieve? What type of talent do you need? Save time, we have skill-equipped engineers in line with your goals.</p>
            </div>
          ...
          <section className='hireUs_Section'>
            <div>
                ...
                <div className='contentWrapper'>
                    ...
                    <p>Our highly trained engineers take your business ideas to release by using the best frameworks in project development. Would you like to give us a trial?</p>
                    <div className='ctaWrapper'>
                        <a className='primaryButton' href='#'>Become a client</a>
                        <a className='secondaryButton' href='#'>View skills</a>
                    </div>
                </div>
            </div>
          </section>
                ...
                <div className='steps'>
                    <div className='step'>
                      ...
                      <div>
                        ...
                        <div>
                          <span>STEP 1</span>
                          <p>A 30 minutes exploratory call is set up with the founder</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='step'>
                      ...
                      <div>
                        ...
                        <div>
                          <span>STEP 2</span>
                          <p>A feedback email will be sent to you in 3-4 days with details of the talent(s) for hire</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='step'>
                      ...
                      <div>
                        ...
                        <div>
                          <span>STEP 3</span>
                          <p>A 30 minutes interview call with the talent will follow thus</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='step'>
                      ...
                      <div>
                        ...
                        <div>
                          <span>STEP 4</span>
                          <p>A contract will be signed by both parties upon agreement with costs and hiring model.</p>
                        </div>
                      </div>
                    </div>
                </div>
          ...
          <section className='techSkillsSection section_with_subSections'>
            ...
            <div className='techSkillWrapper should_stack'>
              ...
              <div className='contentWrapper'>
                ...
                <p>We have a large number of talented developers with different skills in the tech space</p>
              </div>
