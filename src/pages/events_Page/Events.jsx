    ...
    <div className="eventsWrapper ">
      <section className="talentHunt_Section">
        <div className="contentWrapper">
          ...
          <p>
            We are searching for people who desire bigger things in their
            careers, who are willing to take a bigger step to create a vision
        ...
        <div className="booking">
          <div className="bookInfo">
            ...
            <a className="primaryButton notMobile" href="#">
              Book now (free)
            </a>
          </div>
            ...
            <a className="viewProgram notMobile" href="#">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M12.5803 4.01195L10.2902 1.72653V1.71654C9.89023 1.31735 9.89023 0.688614 10.2902 0.299397C10.6802 -0.0997992 11.3102 -0.0997992 11.7102 0.299397L15.7102 4.29136C15.9461 4.5207 16.0393 4.84492 15.9899 5.15148C15.9516 5.41804 15.8066 5.65147 15.6 5.80702L11.6995 9.6996C11.5095 9.87924 11.2495 9.98902 10.9895 9.98902L10.9995 10C10.7295 10 10.4695 9.89022 10.2895 9.71058C9.88954 9.32137 9.88954 8.68265 10.2795 8.29344V8.28345L12.5596 6.00793H1C0.44 6.00793 0 5.55883 0 5.00994C0 4.45106 0.44 4.01195 1 4.01195H12.5803Z"
                  fill="url(#paint0_linear_1020_1901)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_1020_1901"
                    x1="0"
                    y1="5"
                    x2="16.0027"
                    y2="5"
    ...
    <div className="eventCard">
      ...
      <div className="eventDetails">
        ...
        <div className="event_Info">
          ...
          <p>
            Federal Secretariat Complex, Phase 1, Maitama P.M.B. 406 Garki
            Abuja-FCT, Nigeria.
          </p>
  ...
  return (
    <div className="testCard">
      ...
      <div className="testifier_message">
        <p>
          Segsalerty has invested in the growth of young superstars through
          mentorship. Our focus is to build a community of young men and women
          of purpose in the industry
        </p>
        <p>
          With our highly vetted mentors and regular skill in-house challenges,
          our Engineers have stood the test of time in building quality software
          solutions
        </p>
