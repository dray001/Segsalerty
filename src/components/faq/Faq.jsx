      ...
      <div className="processWrapper should_stack">
        ...
        <div className="questionsWrapper">
          <div className="question">
            <p>How much do I have to pay for STS?</p>
          ...
          <div className="question">
            <p>What do I need to do to qualify for STS?</p>
          ...
          <div className="question">
            <p>How long does STS training last?</p>
          ...
          <div className="question">
            <p>Does Segsalerty promise job oppurtunities ?</p>
          ...
          <div className="question">
            <p>
              What tech skills do i need to posses to be a member of the
              community?
            </p>
